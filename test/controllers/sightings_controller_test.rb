...
class SightingsControllerTest < ActionController::TestCase
  ...
  test "should create sighting" do
    assert_difference('Sighting.count') do
      post :create, sighting: { fuckedup: @sighting.fuckedup, lat: @sighting.lat, long: @sighting.long, name: @sighting.name }
    end
  ...
  test "should update sighting" do
    patch :update, id: @sighting, sighting: { fuckedup: @sighting.fuckedup, lat: @sighting.lat, long: @sighting.long, name: @sighting.name }
    assert_redirected_to sighting_path(assigns(:sighting))
  end
